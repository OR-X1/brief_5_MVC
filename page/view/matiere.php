...
?>
  ...
  <div class="d-flex">
    ...
    <div class="sidebar col-md-3">
      <ul class="list-group">
        <li class="" ><a class="list-group-item list-group-item-dark " href="http://localhost/www/brief%205%20MVC/page/salle">Salle</a></li>
        <li ><a class="list-group-item list-group-item-dark "
            href="http://localhost/www/brief%205%20MVC/page/groupe">Groupe</a></li>
        <li ><a class="list-group-item list-group-item-dark disabled" href="">Matiere</a></li>
    ...
    <div class="col-md-9 m-sm-4 ">
      ...
      <form action="http://localhost/www/brief%205%20MVC/page/matiere/save" method="post" id="idForm"
          ...
          <tr>
            ...
            <td >
              ...
              <div class="d-flex text-center">
                <form action="http://localhost/www/brief%205%20MVC/page/matiere/edit" method="post">
                ...
                <form action="http://localhost/www/brief%205%20MVC/page/matiere/delete" method="post">
  ...
  function add() {
    ...
    if (Libelle != '') {
      idForm.innerHTML += '<br><div class="d-flex"><div class="col-md-5"><input type="text" disabled="disabled" name="Libelle' + i +
        ...
        '" placeholder="Libelle"></div><div class="col-md-1"></div></div>';
      i++;
    } else {
